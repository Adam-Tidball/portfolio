      ...
      <main className="flex flex-col gap-8 row-start-2 w-full lg:w-2/3">
        ...
        <section id="Projects" className="flex flex-col gap-4">
          ...
          <ul className="flex flex-col gap-4">
            <li>
              <h3 className="text-md font-bold">Marketplace Application</h3>
              <p>
              ...
              <div className="flex justify-center mt-8">
                <div className="w-full xl:w-3/4">
                  <p className="text-center italic">Recommender Logic Diagram:</p>
                  <Image
              ...
              <div className="flex justify-center mt-8">
                <div className="w-full xl:w-3/4">
                  <p className="text-center italic">Recommendation UI:</p>
                  <Image
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6 sm:gap-12 items-center mt-12">
            <a
