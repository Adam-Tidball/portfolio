      ...
      <main className="flex flex-col gap-8 row-start-2 w-full lg:w-2/3 ">
        <div className="flex flex-col gap-4 items-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6 sm:gap-12 items-center">
            ...
            <a
              className="px-4 py-2 rounded-full border border-solid border-black/[.08] hover:bg-black/[.08]"
              href="resumes/Adam B. Tidball - 1 pg resume - Website.pdf"
              target="_blank"
        ...
        <section id="Projects" className="flex flex-col gap-4">
          ...
          <ul className="flex flex-col gap-4">
            <li>
              ...
              <p>
                I worked as a memeber of a 12 person development team to create a marketplace application for the University of Victoria. The application was desgined using a micro serivce architecutre, replying on Restfull APIs for communication between the services and being scaled and deployed utlizing docker containers. My primary role was to develop the recommendation system that would suggest items to users based on their previous interactions with the application. 
                <br />
                <br />
